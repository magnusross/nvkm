...
for i in range(2):
    ...
    axs = fig.add_subplot(gs[1:4, g_posl[i] : g_posl[i] + 3])
    axs.imshow(
...
for i in range(2):
    ...
    axs = fig.add_subplot(gs[0, g_posl[i] : g_posl[i] + 3])
...
for i in range(2):
    ...
    axs = fig.add_subplot(gs[0, fs_posl[i] : fs_posl[i] + 3])
    axs.plot(ty, y1_samps[i], color="green")
    axs.axis("off")
    axs = fig.add_subplot(gs[3, fs_posl[i] : fs_posl[i] + 3])
    axs.plot(ty, y_samps[i] - y1_samps[i], color="green")
    axs.axis("off")
    axs = fig.add_subplot(gs[5, fs_posl[i] : fs_posl[i] + 3])
